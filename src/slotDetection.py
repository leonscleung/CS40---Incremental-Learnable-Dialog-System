...
<<<<<<< HEAD
                ...
                try:
                    flight_date = datetime.datetime(year=today.year, month=MONTH_DICT[month], day=monthRange)
                except:
                    flight_date = datetime.datetime(year=today.year, month=MONTH_DICT[month], day=monthRange-1)
            elif 'first day' in message:
